...
- un fichier `.flatpak`, pour n'importe quelle distribution dotée de Flatpak, dans les versions construites depuis son ajout. Le lien Version stable propose à la place `github-desktop-stable.flatpakref`, pour la raison donnée plus bas.
